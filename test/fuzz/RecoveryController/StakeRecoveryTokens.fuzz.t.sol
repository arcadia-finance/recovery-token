...
/**
 * @notice Fuzz tests for the function "stakeRecoveryTokens" of "RecoveryController".
 */
contract StakeRecoveryTokens_RecoveryController_Fuzz_Test is RecoveryController_Fuzz_Test {
    /* ///////////////////////////////////////////////////////////////
                                SETUP
    /////////////////////////////////////////////////////////////// */
    ...
    /* ///////////////////////////////////////////////////////////////
                                TESTS
    /////////////////////////////////////////////////////////////// */
    function testFuzz_Revert_stakeRecoveryTokens_NotActive(address user, uint256 amount) public {
        // Given: "RecoveryController" is not active.

        // When: "user" calls "stakeRecoveryTokens" with "amount".
    ...
    function testFuzz_Revert_stakeRecoveryTokens_ZeroAmount(address user) public {
        // Given: "RecoveryController" is active.
        recoveryControllerExtension.setActive(true);

        // When: "user" calls "stakeRecoveryTokens" with 0 amount.
        // Then: Transaction reverts with "DRT: ZeroAmount".
        vm.prank(user);
        vm.expectRevert(ZeroAmount.selector);
        recoveryControllerExtension.stakeRecoveryTokens(0);
    }

    function testFuzz_Revert_stakeRecoveryTokens_InsufficientBalance(uint256 amount, UserState memory user) public {
        // Given: "RecoveryController" is active.
        recoveryControllerExtension.setActive(true);
    ...
    function testFuzz_Success_stakeRecoveryTokens_NoInitialPosition(
        uint256 amount,
        ...
        // And: Amount is strictly greater as zero (zero amount reverts see: testFuzz_Revert_stakeRecoveryTokens_ZeroAmount).
        uint256 minAmount = 1;
        ...
        assertEq(stakedRecoveryToken.balanceOf(user.addr), amount);
    ...
    function testFuzz_Success_stakeRecoveryTokens_WithInitialPosition_NonRecoveredPosition(
        uint256 amount,
        UserState memory user,
        ControllerState memory controller
    ) public {
    ...
    function testFuzz_Success_stakeRecoveryTokens_WithInitialPosition_FullyRecoveredPosition_LastPosition(
        uint256 amount,
        UserState memory user,
        ControllerState memory controller
    ) public {
    ...
    function testFuzz_Success_stakeRecoveryTokens_WithInitialPosition_FullyRecoveredPosition_NotLastPosition(
        uint256 amount,
        UserState memory user,
        ControllerState memory controller
    ) public {
        ...
        uint256 surplus = user.redeemed + redeemable - user.balanceSRT - amount;
